...
namespace aruodasltOOPInheritence0731vak.Tests
{
    internal class PlotTests
    {
        ...
        {
            Plot p = new Plot("Šiauliai", "Šiaulių", "Centras", "Alytaus", "15", "50", true, true, true, "863664521", "25000", "1991-0008-5014", "Parduodamas gyvenamosios paskirties sklypas 50a., draugiska kaiminyste, esfaltuotas kelias iki sklypo",
                "https://www.youtube.com/watch?v=AN0lSytPFRo", "https://www.youtube.com/watch?v=jfC71hOeV4A", new int[] { 4, 5, 6 },
                new int[] { 2, 4, 6, 8 });
            p.fill();
        ...
        //{
        //    Plot p = new Plot("Vilnius", "Vilniaus m.","30");
        //  //  p.ChooseLocation();
        //}
        [OneTimeSetUp]
